...
---
### 코드 리뷰
[동기분 코드](https://github.com/Mistle0108/Backjoon-Code-Capture/blob/main/%EB%B0%B1%EC%A4%80/Bronze/1546.%E2%80%85%ED%8F%89%EA%B7%A0/%ED%8F%89%EA%B7%A0.java)
- 스트림이 간단하긴한데 수행복잡도가 결국 O(n)이라 수행시간 단점이 있음.  애초에 점수 입력을 stream으로 받아서 최댓값 추출을 별도로 했는데, 이 방식이 아니라 그냥 for문으로 받아오면서 최댓 값 비교도 같이했으면 유의미한 시간 단축이었을 듯
